...
上面是能力演示。这里是**用 skill 做出来、在真实场景中交付的东西**——不是示意，是实际在用的。

### 北大 AI 心理学讲座 PPT

花叔 2026 年 4 月在北京大学的 AI 心理学讲座完整讲稿。90 页幻灯片全部由 huashu-design 生成
HTML deck，导出 PDF 后上讲台直接用。涵盖 Persona Selection Model、Emotion Concepts、
Introspective Awareness 等 Anthropic 2025-2026 AI 心理学论文的系统化整理。

[📄 下载 PDF](demos/s1-real-deck-pku-ai-psychology.pdf)（14 MB）

### Kimi MultiClaw 群聊动画

给 Kimi MultiClaw（龙虾群聊功能）做的品牌动画，A/B 角色混搭叙事 + BGM。
从 brand-spec 到成片（含音频）一条龙走 skill 流水线。

<p align="center">
  <video src="demos/s2-real-anim-kimi-multiclaw.mp4" autoplay muted loop playsinline width="100%">
    您的浏览器暂不支持内联视频，请<a href="demos/s2-real-anim-kimi-multiclaw.mp4">下载 MP4</a>。
  </video>
</p>
